...
///
/// **Note:** This trait will be removed in a future release. Use [`OptimizationProblem`]
/// with solver methods like `minimize()` instead.
///
...
///
/// **Note:** This trait will be removed in a future release. Use [`OptimizationProblem`]
/// with solver methods like `maximize()` instead.
///
