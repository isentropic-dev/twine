use twine_core::{
    TimeIntegrable,
    thermo::units::{SpecificEnthalpy, SpecificEntropy, SpecificInternalEnergy},
};
...
///
/// - A general-purpose model like [`IdealGas`] can be used with any fluid
///   that satisfies a capability trait (e.g. `F: TimeIntegrable + IdealGasProperties`),
///   allowing reuse across many ideal gas fluids.
///
...
pub trait ThermodynamicProperties<Fluid: TimeIntegrable> {
